...
export function ThemeToggle({ theme, onToggle }: { theme: "light" | "dark"; onToggle: () => void }) {
  return (
    <button
      ...
      className="land-press size-9 rounded-md border border-line text-ink-body hover:text-ink flex items-center justify-center transition-colors duration-200"
    >
